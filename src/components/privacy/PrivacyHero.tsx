...
const PrivacyHero = () => {
  ...
  return (
    ...
    >
      <div className="relative mx-auto w-full max-w-[1440px] overflow-hidden lg:h-[660px]">
        ...
        <motion.div
          ...
          className="relative px-6 py-16 sm:px-10 lg:px-20 lg:py-0 lg:pt-[79.5px]"
        >
          ...
          <h1
            ...
            className="text-[44px] font-bold leading-[1.11] tracking-[-0.039em] text-black sm:text-[56px] lg:text-[72px] lg:leading-[79px]"
          >
            {lang === "ja" ? (
              <>
