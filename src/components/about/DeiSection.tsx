...
const DeiSection = () => {
  ...
  return (
    <section data-nav-theme="dark" data-probe="s-dei" className="w-full bg-white">
      {/* The mobile export insets the panel 8px, rounds it 12, and sets its padding to
          28 — the same panel, just tightened to the narrower page. */}
      <div className="mx-auto w-full max-w-[1440px] p-2 sm:p-4">
        <div className="rounded-xl bg-[linear-gradient(154.75deg,#0A0A0A_36.18%,#273953_99.94%)] px-7 py-12 text-center sm:rounded-2xl sm:px-10 sm:py-16 lg:px-[clamp(24px,3.4722vw,50px)] lg:pb-[99.8px] lg:pt-[101.3px]">
          <ScrollReveal>
            <p
            ...
            <h2
              ...
              className="mx-auto mt-[23px] max-w-[1100px] text-[32px] font-bold leading-[1.0925926] text-white sm:text-[42px] lg:text-[clamp(38px,3.75vw,54px)]"
            >
              {t.heading}
            </h2>
          </ScrollReveal>
