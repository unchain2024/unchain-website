    ...
    >
      <div className="relative mx-auto w-full max-w-[1440px] lg:min-h-[515px]">
        ...
        <motion.div
          ...
          className="relative z-10 px-6 pb-16 pt-[120px] sm:px-10 md:max-w-[58%] lg:max-w-none lg:px-[clamp(40px,5.5556vw,80px)] lg:pb-0 lg:pt-[130px]"
        >
          ...
          <h1
            ...
            className="text-[44px] font-bold leading-none tracking-[-0.045em] text-black sm:text-[56px] lg:text-[clamp(48px,5vw,72px)]"
          >
            {t.heading}
          </h1>
